...
- There are 4 main access modifiers in TypeScript: `static`, `private`, `public`, and `protected`.
- `static` modifier means that the property or the method is defined on the class but not the instance.
