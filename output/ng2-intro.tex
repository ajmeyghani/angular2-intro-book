...
\item
  ...
  in our typescript code. Let's put a breakpoint on line 2 and start the
  debugger by clicking on the margin of line 2.
\item
...
\item
  ...
  \href{https://github.com/Microsoft/vscode-chrome-debug}{extension}
  open the prompt in VSCode with \texttt{command\ +\ shift\ +\ p} and
  type:
