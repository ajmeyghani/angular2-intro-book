...
\subsubsection{Shadow DOM Basics}\label{shadow-dom-basics}

\textbf{TODO} (shadow dom, light dom, etc.)

\subsubsection{Simple Directive}\label{simple-directive}

\textbf{TODO} (writing a custom directive)
...
\item
  Usage:
  \texttt{\textless{}ul\textgreater{}\ \textless{}li\ *ngFor="\#item\ of\ items"\textgreater{}\ ...\ \textless{}/li\textgreater{}\ \textless{}/ul\textgreater{}}
\end{itemize}
...
endpoint. We are going to call this \texttt{StudentSvc}:
